# @kolisachint/hoocode-web-ui

Reusable web UI components for building AI chat interfaces powered by [@kolisachint/hoocode-ai](../ai) and [@kolisachint/hoocode-agent-core](../agent).

Built with [@kolisachint/hoocode-mini-lit](../mini-lit) web components and Tailwind CSS v4.
...
```bash
npm install @kolisachint/hoocode-web-ui @kolisachint/hoocode-agent-core @kolisachint/hoocode-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@kolisachint/hoocode-web-ui';
import '@kolisachint/hoocode-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { SessionListDialog } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@kolisachint/hoocode-web-ui';
...
```typescript
import { ModelSelector } from '@kolisachint/hoocode-web-ui';
...
```css
@import '@kolisachint/hoocode-mini-lit/themes/claude.css';
@tailwind base;
@tailwind components;
@tailwind utilities;
```
...
```typescript
import { i18n, setLanguage, translations } from '@kolisachint/hoocode-web-ui';

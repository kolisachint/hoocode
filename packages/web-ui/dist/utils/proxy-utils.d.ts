import type { Api, Context, Model, SimpleStreamOptions } from "@kolisachint/hoocode-ai";
/**
 ...
 * @param apiKey - API key for the provider
 * @param proxyUrl - CORS proxy URL (e.g., "https://your-proxy.example.com/proxy")
 ...
 */
export declare function createStreamFn(getProxyUrl: () => Promise<string | undefined>): (model: Model<any>, context: Context, options?: SimpleStreamOptions) => Promise<import("@kolisachint/hoocode-ai").AssistantMessageEventStream>;

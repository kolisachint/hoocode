 ...
 */
import type { Model, Usage } from "@kolisachint/hoocode-ai";
...
export declare function prepareCompaction(pathEntries: SessionTreeEntry[], settings: CompactionSettings): CompactionPreparation | undefined;
/**

...
import type { CompactionPreparation, CompactionResult } from "./compaction/compaction.js";
...
export interface CompactionEntry<T = unknown> extends SessionTreeEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if harness-generated (backward compatible) */
	fromHook?: boolean;
}
...
/** Alias kept for the harness event API; the canonical type lives in compaction. */
export type CompactResult = CompactionResult;

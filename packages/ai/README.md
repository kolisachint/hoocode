...
```bash
npm install @kolisachint/hoocode-ai
```

TypeBox exports are re-exported from `@kolisachint/hoocode-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@kolisachint/hoocode-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@kolisachint/hoocode-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@kolisachint/hoocode-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@kolisachint/hoocode-ai';
...
```typescript
import { getImageModel, generateImages } from '@kolisachint/hoocode-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@kolisachint/hoocode-ai';
...
```typescript
import { getModel, stream } from '@kolisachint/hoocode-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@kolisachint/hoocode-ai';
...
```typescript
import { Model, stream } from '@kolisachint/hoocode-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@kolisachint/hoocode-ai';
...
```typescript
import { getModel, complete, Context } from '@kolisachint/hoocode-ai';
...
```typescript
import { Context, getModel, complete } from '@kolisachint/hoocode-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@kolisachint/hoocode-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@kolisachint/hoocode-ai';
...
```bash
npx @kolisachint/hoocode-ai login              # interactive provider selection
npx @kolisachint/hoocode-ai login anthropic    # login to specific provider
npx @kolisachint/hoocode-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@kolisachint/hoocode-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
```typescript
import { loginGitHubCopilot } from '@kolisachint/hoocode-ai/oauth';
...
```typescript
import { getModel, complete } from '@kolisachint/hoocode-ai';
import { getOAuthApiKey } from '@kolisachint/hoocode-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@kolisachint/hoocode-ai`

...
// Google's token endpoint rejects these clients without a client_secret, so
// unlike the Anthropic and OpenAI logins this one cannot run as a bare public
// PKCE client. hoocode ships no credentials; see google-oauth-client.ts.
const CLIENT_ENV: GoogleOAuthClientEnv = {
	idVar: "HOOCODE_GEMINI_CLI_CLIENT_ID",
	secretVar: "HOOCODE_GEMINI_CLI_CLIENT_SECRET",
	productName: "Google Cloud Code Assist (Gemini CLI)",
};

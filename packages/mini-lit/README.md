# @kolisachint/hoocode-mini-lit

Lightweight Lit components with shadcn-inspired theming, Tailwind CSS v4 styling, and Lucide icons. Vendored fork of [`@mariozechner/mini-lit`](https://github.com/badlogic/mini-lit) (MIT, © Mario Zechner) for use in HooCode.
...
```bash
npm install lit @kolisachint/hoocode-mini-lit
```
...
@import "@kolisachint/hoocode-mini-lit/styles/themes/default.css";

/* Tell Tailwind to scan mini-lit components */
@source "../node_modules/@kolisachint/hoocode-mini-lit/dist";
...
import { Button } from "@kolisachint/hoocode-mini-lit/dist/Button.js";
import { Card } from "@kolisachint/hoocode-mini-lit/dist/Card.js";
import { icon } from "@kolisachint/hoocode-mini-lit/dist/icons.js";
import "@kolisachint/hoocode-mini-lit/dist/ThemeToggle.js";
...
```typescript
import { Button, Card, Badge } from "@kolisachint/hoocode-mini-lit";
...
import "@kolisachint/hoocode-mini-lit";
...
**IMPORTANT**: The root index (`@kolisachint/hoocode-mini-lit`) now only exports core utilities (component system, i18n, and icons). Individual components are **not** exported from the root to encourage optimal tree-shaking.
...
import { i18n, setTranslations, createComponent } from "@kolisachint/hoocode-mini-lit";
```
...
```css
@import "@kolisachint/hoocode-mini-lit/styles/themes/claude.css";
```
...
```typescript
declare module "@kolisachint/hoocode-mini-lit" {
...
```typescript
import { setTranslations, defaultEnglish, defaultGerman } from "@kolisachint/hoocode-mini-lit";
...
```typescript
import { i18n, getCurrentLanguage, setLanguage } from "@kolisachint/hoocode-mini-lit";
...
This package lives inside the [HooCode monorepo](https://github.com/kolisachint/hoocode) alongside an example gallery showcasing all components.
...
See the `/example` directory for a complete working example with all components.

## Resources

- [npm Package](https://www.npmjs.com/package/@kolisachint/hoocode-mini-lit)
- [Lit Documentation](https://lit.dev)
- [Tailwind CSS v4](https://tailwindcss.com)

## Credits

Forked from [`@mariozechner/mini-lit`](https://github.com/badlogic/mini-lit) by Mario Zechner. Distributed under the MIT License.

import { Box, Markdown, Spacer, Text } from "@kolisachint/hoocode-tui";
...
export class CompactionSummaryMessageComponent extends Box {
    ...
    updateDisplay() {
        ...
        const summaryText = after !== undefined && this.message.tokensBefore > 0
        ...
        if (this.expanded) {
            ...
            this.addChild(new Text(theme.fg("customMessageText", `${summaryText} (`) +

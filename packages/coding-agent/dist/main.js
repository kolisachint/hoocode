...
import { modelsAreEqual } from "@kolisachint/hoocode-ai";
...
export async function main(args, options) {
    resetTimings();
    const offlineMode = args.includes("--offline") || isTruthyEnvFlag(process.env.HOOCODE_OFFLINE ?? process.env.PI_OFFLINE);
    if (offlineMode) {

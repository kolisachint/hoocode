...
- [`packages/agent/src/types.ts`](https://github.com/kolisachint/hoocode/blob/main/packages/agent/src/types.ts) - AgentMessage union type

For TypeScript definitions in your project, inspect `node_modules/@kolisachint/hoocode-agent/dist/` and `node_modules/@kolisachint/hoocode-ai/dist/`.

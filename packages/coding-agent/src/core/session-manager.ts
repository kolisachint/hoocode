import type {
	...
	SessionTreeEntryBase as SessionEntryBase,
	SessionInfoEntry,
	MessageEntry as SessionMessageEntry,
	ThinkingLevelChangeEntry,
} from "@kolisachint/hoocode-agent-core";
import { buildSessionContext as buildContextFromPath } from "@kolisachint/hoocode-agent-core";
...
export function buildSessionContext(
	...
	// The scan over the root-first path (settings, compaction handling, message
	// extraction) is shared with the agent harness.
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.hoocode/agent/sessions/<encoded-cwd>/).
	 */

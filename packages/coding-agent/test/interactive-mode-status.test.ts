...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.hoocode/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.hoocode/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.hoocode/extensions",
				}),
			},
			{
				path: "/tmp/project/.hoocode/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.hoocode/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.hoocode/extensions",
			...
			{
				path: "/tmp/project/.hoocode/npm/node_modules/pi-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.hoocode/npm/node_modules/pi-markdown-preview/extensions/index.ts",
					{
						...
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.hoocode/npm/node_modules/pi-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.hoocode/npm/node_modules/@scope/pi-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.hoocode/npm/node_modules/@scope/pi-scoped/extensions/index.ts",
					{
						...
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.hoocode/npm/node_modules/@scope/pi-scoped",
					},
				),
			},
			{
				path: "/tmp/project/.hoocode/git/github.com/HazAT/pi-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.hoocode/git/github.com/HazAT/pi-interactive-subagents/extensions/index.ts",
					{
						...
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.hoocode/git/github.com/HazAT/pi-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.hoocode/git/github.com/HazAT/pi-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(

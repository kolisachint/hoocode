import type { ExtensionAPI, ExtensionCommandContext } from "@kolisachint/hoocode-agent";
import { DynamicBorder, getMarkdownTheme } from "@kolisachint/hoocode-agent";
import { complete, getModel } from "@kolisachint/hoocode-ai";
import { Container, Markdown, matchesKey, Text } from "@kolisachint/hoocode-tui";

 ...
 * - Routing tool calls to remote systems (e.g., an ssh-remote extension)
...
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@kolisachint/hoocode-agent";

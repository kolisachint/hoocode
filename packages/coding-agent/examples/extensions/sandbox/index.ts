 ...
 *
 * Setup:
 * 1. Copy sandbox/ directory to ~/.hoocode/agent/extensions/
 * 2. Run `npm install` in ~/.hoocode/agent/extensions/sandbox/
 *
...
import { type BashOperations, createBashTool, getAgentDir } from "@kolisachint/hoocode-agent";

 ...
 *
 * Usage: hoocode --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@kolisachint/hoocode-tui";

export default function (hoo: ExtensionAPI) {
	hoo.registerCommand("overlay-test", {

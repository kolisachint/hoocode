...
| `send-user-message.ts` | Demonstrates `hoo.sendUserMessage()` for sending user messages from extensions |
...
| `event-bus.ts` | Inter-extension communication via `hoo.events` |

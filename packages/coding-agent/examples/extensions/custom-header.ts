 ...
 * (logo + keybinding hints) with a custom component showing the hoocode mascot.
 */

import type { ExtensionAPI, Theme } from "@kolisachint/hoocode-agent";
...
export default function (hoo: ExtensionAPI) {
	...
	hoo.registerCommand("builtin-header", {

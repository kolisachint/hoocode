 ...
 *   hoocode -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... hoocode -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (hoo: ExtensionAPI) {
	hoo.registerProvider("custom-anthropic", {

 ...
 * Delegates to @kolisachint/hoocode-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   hoocode -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (hoo: ExtensionAPI) {
	hoo.registerProvider("gitlab-duo", {

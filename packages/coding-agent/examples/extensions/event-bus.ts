 ...
 *
 * Shows hoo.events for communication between extensions. One extension
...
export default function (hoo: ExtensionAPI) {
	...
	hoo.events.on("my:notification", (data) => {

...
export class TUI extends Container {
    ...
    showHardwareCursor = (process.env.HOOCODE_HARDWARE_CURSOR ?? process.env.PI_HARDWARE_CURSOR) === "1";
    clearOnShrink = (process.env.HOOCODE_CLEAR_ON_SHRINK ?? process.env.PI_CLEAR_ON_SHRINK) === "1"; // Clear empty rows when content shrinks (default: off)
